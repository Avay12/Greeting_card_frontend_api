...
const ALL_PRODUCTS: Product[] = [
  {
    ...
    price: 4.99,
    image: "https://images.unsplash.com/photo-1583847268964-b28e50b58257?auto=format&fit=crop&q=80&w=800&h=1000",
    category: "Birthday",
    isBestseller: true,
  },
  {
    ...
    price: 3.50,
    image: "https://images.unsplash.com/photo-1549465220-1a8b9238cd48?auto=format&fit=crop&q=80&w=800&h=1000",
    category: "Thank You",
    isBestseller: true,
  },
  {
    ...
    price: 5.99,
    image: "https://images.unsplash.com/photo-1516244671391-62ecafdcabf7?auto=format&fit=crop&q=80&w=800&h=1000",
  ...
  },
  {
    ...
    price: 6.50,
    image: "https://images.unsplash.com/photo-1481024387227-2e2124508cfa?auto=format&fit=crop&q=80&w=800&h=1000",
    category: "Love",
  },
  {
    id: "5",
    ...
    price: 4.99,
    image: "https://images.unsplash.com/photo-1544457070-4cd773b4d71e?auto=format&fit=crop&q=80&w=800&h=1000",
    category: "Seasonal",
  },
  {
    id: "6",
    ...
    price: 3.99,
    image: "https://images.unsplash.com/photo-1478147427282-58a871190bc3?auto=format&fit=crop&q=80&w=800&h=1000",
    category: "Thank You",
  },
  {
    id: "7",
  ...
  },
  {
    ...
    price: 4.50,
    image: "https://images.unsplash.com/photo-1530103862676-de889fa09fce?auto=format&fit=crop&q=80&w=800&h=1000",
    category: "Birthday",
  },
];

const CATEGORY_TABS = ["All", "Birthday", "Thank You", "Love", "Wedding", "Congratulations", "Seasonal"];
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center z-10 p-8 md:p-16 w-full">
            ...
            >
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-primary/10 text-primary text-sm font-medium mb-6">
                <Star className="w-4 h-4 fill-primary" /> 10,000+ Happy Customers
              </div>
              ...
              <p className="text-lg md:text-xl text-muted-foreground mb-8">
                Handcrafted greeting cards for every special moment. Premium paper, thoughtful designs, delivered with love.
              </p>
            ...
            >
              ...
              >
                <div className="w-full h-full bg-primary/10 rounded-xl flex items-center justify-center">
                  <span className="text-4xl text-center font-heading font-medium text-primary">Thank<br/>You</span>
                </div>
              </motion.div>
            </motion.div>
          </div>
      ...
      <section id="collection" className="container mx-auto px-4 scroll-mt-24">
        ...
        {filteredProducts.length === 0 && (
          <div className="text-center py-24 text-muted-foreground">
            <p className="text-lg">Check back soon for new designs in this category!</p>
          </div>
        )}
      </section>
