...
export default function CartPage() {
    ...
    return (
      <div className="container mx-auto px-4 py-24 text-center">
        ...
        >
          ...
          <p className="text-muted-foreground mb-12">Looks like you haven't added any cards to your cart yet.</p>
  ...
  return (
    <div className="container mx-auto px-4 py-16">
      <h1 className="font-heading text-4xl md:text-5xl font-bold mb-12">Your Shopping Cart</h1>
        ...
        <div className="lg:col-span-2 space-y-6">
          <AnimatePresence mode="popLayout">
            {cart.map((item) => (
              ...
              >
                <div className="relative w-full sm:w-32 aspect-square rounded-2xl overflow-hidden bg-muted">
                ...
                <div className="flex-1">
                  <div className="flex justify-between items-start mb-2">
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground uppercase tracking-widest">{item.category}</p>
                    </div>
                    <button
          ...
          >
            ...
            <div className="space-y-4 mb-8">
              ...
              <div className="flex justify-between text-xl font-bold">
                <span>Total</span>
                <span className="text-primary">${(total + shipping + tax).toFixed(2)}</span>
              </div>
            </div>
