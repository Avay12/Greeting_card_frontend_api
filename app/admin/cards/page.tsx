...
export default function AdminCardsPage() {
  ...
  const [editFormData, setEditFormData] = useState({ title: "", category: "", price: 0 });
  ...
  return (
    <div className="max-w-7xl mx-auto space-y-6 relative">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-gray-900 font-heading">Manage Cards</h1>
          <p className="mt-2 text-gray-600">View and edit available greeting card templates.</p>
        </div>
           ...
           <div className="fixed inset-0 z-[60] flex items-center justify-center p-4">
              ...
              >
                 <div className="flex items-center justify-between mb-6">
                    <h2 className="text-xl font-bold text-gray-900 font-heading">Edit Card</h2>
                    <button 
                       onClick={() => setEditingCard(null)}
                 ...
                 <form onSubmit={handleUpdate} className="space-y-4">
                    ...
                    <div>
                       <label className="block text-sm font-semibold text-gray-700 mb-1 ml-1">Title</label>
                       <input 
                          type="text" 
                    ...
                    <div>
                       <label className="block text-sm font-semibold text-gray-700 mb-1 ml-1">Price</label>
                       <input 
                          type="number" 
                          step="0.01"
                          value={editFormData.price}
                          onChange={(e) => setEditFormData(p => ({ ...p, price: parseFloat(e.target.value) || 0 }))}
                          className="w-full bg-gray-50 border border-gray-200 rounded-xl py-3 px-4 focus:ring-2 focus:ring-primary/20 outline-none"
                          required
                       />
                    </div>
